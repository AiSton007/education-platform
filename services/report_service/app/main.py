"""Application entrypoint for ``report-service``."""
...
from services.report_service.app.deps import deps
from services.report_service.app.routes.reports import router as reports_router
